...
from FindAureus.FindaureusFunctions_Validation import *
...
found_bacteria_in_fake_bacteria_image, found_bacteria_coordinates_in_fake_bacteria_image, found_no_bacteria_in_fake_bacteria_image,_,_,_ = FindBacteriaAndNoBacteria(fake_images_with_bacteria, metadata)
