...
from Validation.Validation_li.FindAureusFunctions_li import *
...
found_bacteria_in_fake_bacteria_image, found_bacteria_coordinates_in_fake_bacteria_image, found_no_bacteria_in_fake_bacteria_image,_,_,_ = FindBacteriaAndNoBacteria_li(fake_images_with_bacteria, metadata)
...
with open(output_folder+'\Object_Variable_li_T.pkl', 'wb') as f: 
...
# import pandas as pd
# input_folder = 'path'
# obj = pd.read_pickle(input_folder+'\Object_Variable_li_T1.pkl')