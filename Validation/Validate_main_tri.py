...
from Validation_Functions.ValidateFunction_tri import *
...
found_bacteria_in_fake_bacteria_image, found_bacteria_coordinates_in_fake_bacteria_image, found_no_bacteria_in_fake_bacteria_image,pw_bac_coordinates,_,_ = FindBacteriaAndNoBacteria_tri(fake_images_with_bacteria, metadata)
...
#         } 
# output_folder = 'path/'
# output_name_trialno = "Image_1_Tri_T"
